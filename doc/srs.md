...
**REQ-1**: The application must allow to set up groups. A group may be referred to as a *Family*.

**REQ-1.1**: The application must allow to delete the *Family* as well.

**REQ-2**: Each *Family* should allow inclusion of members. For the sake of continuty, a member of the group may be referred to as a *Family Member*.

**REQ-2.1**: The application must allow to update *Family Member* information.

**REQ-2.2**: The application must allow to delete *Family Member(s)*

**REQ-3**: A *Family* may only allow a maximum of 255 members (8-bit data restriction).

**REQ-4**: A *Family* may hold 0 members and no less (obviously!).

**REQ-5**: A *Family* may hold members of whole numbers only (even if one of the members is an infant). i.e. 

        Number of family members in Family A = 5 --> OK
        Number of family members in Family B = 2.5 --> NOT OK
